...
urlpatterns = [
    ...
    path('items/<int:pk>/pay/', views.order_payment_start, name='order_payment_start'),
    # Keep old bookmarks/links working while the winner payment flow uses /pay/.
    path('items/<int:pk>/payments/', views.order_payment_start, name='legacy_order_payment_start'),
